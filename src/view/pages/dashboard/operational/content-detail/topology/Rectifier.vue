  ...
  methods: {
    getdataRect() {
      ...
      ApiService.get(
        ...
        `operation/rtu/topology/${this.idRtu}/?page=${this.currentPage}&limit=${this.perPage}&mode=digital&desc=RECTIFIER`
      )
        .then(({ data }) => {
          ...
          this.dataRect = data.result.payload;
          this.isEmpty = false;
          this.isReady = true;
        })
        .catch((e) => {
