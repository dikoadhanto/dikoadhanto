  ...
  methods: {
    getDataPln() {
      ...
      ApiService.get(
        ...
        `operation/rtu/topology/${this.idRtu}/?page=${this.currentPage}&limit=${this.perPage}&mode=digital&desc=PLN`
      )
        .then(({ data }) => {
          ...
          this.dataPln = data.result.payload;
          this.isEmpty = false;
          this.isReady = true;
        })
        .catch((e) => {
