        ...
        <div class="col-md-10">
          <div class="row">
            ...
            <div class="col-md">
              ...
              <div class="mb-3 row">
                <label class="col-sm-3 col-form-label">Rtu Status :</label>
                <div class="col-sm-9">
                  <treeselect
                    noOptionsText="Data tidak ada"
                    noResultsText="Rtu Status tidak ditemukan"
                    :options="dataRtuStatus"
                    placeholder="Pilih Rtu Status..."
                    v-model="filter.rtuStatus"
                    :clear-on-select="true"
                    @input="setDataRtuStatus"
                  >
                  </treeselect>
                </div>
              </div>
...
export default {
  ...
  watch: {
    getIdRegionalLocMonitoring: function () {
      if (
        this.getIdRegionalLocMonitoring == null ||
        this.getIdRegionalLocMonitoring.length == 0
      ) {
        this.getAllDataWitel();
        this.getAllDataDatel();
        this.getAllDataLokasi();
    ...
    getIdWitelLocMonitoring: function () {
      if (
        this.getIdWitelLocMonitoring == null ||
        this.getIdWitelLocMonitoring.length == 0
      ) {
        if (
          this.getIdRegionalLocMonitoring == null ||
          this.getIdRegionalLocMonitoring.length == 0
    ...
    getIdDatelLocMonitoring: function () {
      if (
        this.getIdDatelLocMonitoring == null ||
        this.getIdDatelLocMonitoring.length == 0
      ) {
        if (
          this.getIdWitelLocMonitoring == null ||
          this.getIdWitelLocMonitoring.length == 0
  ...
  methods: {
    setData() {
      this.filter.regional = this.getIdRegionalLocMonitoring;
      this.filter.witel = this.getIdWitelLocMonitoring;
      this.filter.datel = this.getIdDatelLocMonitoring;
      this.filter.location = this.getIdLocationLocMonitoring;
      this.filter.rtuStatus = this.getRtuStatusLocMonitoring;
      this.filter.tags = this.getIdTagsLocMonitoring;
    },
    setDefaultLocation() {
      this.$store.dispatch("setLocationLocMonitoring", null);
    ...
    setDataRegional() {
      this.$store.dispatch("setRegionalLocMonitoring", this.filter.regional);
    ...
    setDataWitel() {
      this.$store.dispatch("setWitelLocMonitoring", this.filter.witel);
      this.filter.datel = null;
      this.dataDatel = [];
      this.filter.location = null;
      this.dataLokasi = [];
    ...
    setDataDatel() {
      this.$store.dispatch("setDatelLocMonitoring", this.filter.datel);
      this.filter.location = null;
      this.dataLokasi = [];
      this.changeCheckLocation();
    ...
    setDataLocation() {
      this.$store.dispatch("setLocationLocMonitoring", this.filter.location);
    },
    setDataTags() {
      this.$store.dispatch("setTagsLocMonitoring", this.filter.tags);
    },
    setDataRtuStatus() {
      this.$store.dispatch("setRtuStatusLocMonitoring", this.filter.rtuStatus);
    },
  },
};
</script>
